		...
		<div class="row">
			...
			<div class="col-sm-10 col-md-10 col-lg-10 customer-details-card">
				<div class="row">
					...
					<div class="col-sm-2 col-md-2 col-lg-2">
						<input type="text" id="serialNo" value = "<?php echo $currentSerialNo; ?>" class="form-control" readonly>
					</div>
					<div class="col-sm-2 col-md-2 col-lg-2">
...
<!-- weight field section -->
	...
	<div class="row">
		...
		<div class="col-sm-4 col-md-4 col-lg-4">
			<input type="submit" name = "saveCustomerDetailsButton" id = "saveCustomerDetailsButton" class="btn btn-primary form-control" value="<?php echo save; ?>">
		</div>
		<div class="col-sm-4 col-md-4 col-lg-4"></div>
	</div>
</div>
...
<!-- <div class="container">
	<div class="row">
		<div class="col-sm-4 col-md-4 col-lg-4"></div>
		<div class="col-sm-4 col-md-4 col-lg-4">
			<input type="submit" class="btn btn-primary form-control" value="<?php echo printReciept; ?>"
